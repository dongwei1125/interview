        ...
        items: [
          {
            ...
            items: [
              ...
              { text: 'JavaScript字符串的常用方法有哪些？', link: '/string-methods' },
              { text: '谈谈 JavaScript 中的类型转换机制', link: '/type-trans' },
              { text: '== 和 ===区别，分别在什么情况使用', link: '/equal' },
              { text: '深拷贝浅拷贝的区别？如何实现一个深拷贝？', link: '/clone' },
